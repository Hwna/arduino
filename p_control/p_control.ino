...
#define _DUTY_NEU 1400    //[3150] servo neutral position
#define _DUTY_MAX 1475    // [3169] 서보의 최대 가동 각도
...
#define _INTERVAL_SERVO 7 // [3401] 서보를 7ms마다 조작하기
#define _INTERVAL_SERIAL 100  // [3151] 시리얼 0.1초 마다 업데이트

// PID parameters
#define _KP 0.8    // [3158] 비례상수 설정
...
float dist_raw, dist_ema, alpha;    //[3160] 실제 거리측정값과 ema필터를 적용한 값을 저장할 변수
float dist_filtered;
...
const float coE[] = {0.0000097, 0.0006014, 0.6475733, 59.6953395};
...
// initialize serial port
    Serial.begin(115200);                          // [3169] 57600 보드레이트로 아두이노와 통신
